...
/** Should the rows have info to show sections in a grouped tableView? Default value is NO. */
@property BOOL groupedTableView;
...
/** The row's section if using UITableViewStyleGrouped */
@property int groupedViewSection;

/** The row's actual row within a section if using UITableViewStyleGrouped */
@property int groupedViewRow;

/** The row's section's titleForHeaderInSection if using UITableViewStyleGrouped */
@property (readonly) NSString* groupedViewTitleForHeaderInSection;
